...
public class TablaParsing {
    ...
    Hashtable tablaParsing;
    
    public TablaParsing() {
        this.tablaParsing = new Hashtable();
        //Stack st = new Stack(); 
        ...
        tablaParsing.put(SimbolosEnum.JSON_PRIMA.getLexema(), json_prima);
        ...
        tablaParsing.put(SimbolosEnum.JSON.getLexema(), json);
        ...
        tablaParsing.put(SimbolosEnum.ELEMENT.getLexema(), element);
        ...
        tablaParsing.put(SimbolosEnum.ARRAY.getLexema(), array);
        
        //___________________________________________________________________________________________________________________________________________________________________________
        Hashtable array_prima = new Hashtable();   
//        array_prima.put(LexemasEnum.L_LLAVE.getLexema(),         Arrays.asList(
//                                                                Arrays.asList(SimbolosEnum.ELEMENT_LIST.getLexema(), SimbolosEnum.R_CORCHETE.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.R_CORCHETE.getLexema())
//                                                             )); 
...
//        array_prima.put(LexemasEnum.L_CORCHETE.getLexema(),      Arrays.asList(
//                                                                Arrays.asList(SimbolosEnum.ELEMENT_LIST.getLexema(), SimbolosEnum.R_CORCHETE.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.R_CORCHETE.getLexema())
//                                                             ));
        ...
        tablaParsing.put(SimbolosEnum.ARRAY_PRIMA.getLexema(), array_prima);
        ...
        tablaParsing.put(SimbolosEnum.OBJECT.getLexema(), object);
        
        //___________________________________________________________________________________________________________________________________________________________________________
        Hashtable object_prima = new Hashtable();   
        object_prima.put(LexemasEnum.L_LLAVE.getLexema(),         Arrays.asList(SCAN));
        //object_prima.put(LexemasEnum.R_LLAVE.getLexema(),         Arrays.asList(POP));
...
//        object_prima.put(LexemasEnum.LITERAL_CADENA.getLexema(),  Arrays.asList(
//                                                                Arrays.asList(SimbolosEnum.ATTRIBUTE_LIST.getLexema(), SimbolosEnum.R_LLAVE.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.R_LLAVE.getLexema())
//                                                             ));   
        ...
        tablaParsing.put(SimbolosEnum.OBJECT_PRIMA.getLexema(), object_prima);
        
        //___________________________________________________________________________________________________________________________________________________________________________
        Hashtable element_list = new Hashtable();   
//        element_list.put(LexemasEnum.L_LLAVE.getLexema(),         Arrays.asList(
//                                                                //Arrays.asList(SimbolosEnum.ELEMENT_LIST.getLexema(), SimbolosEnum.COMA.getLexema(), SimbolosEnum.ELEMENT.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.ELEMENT.getLexema(), SimbolosEnum.COMA.getLexema(), SimbolosEnum.ELEMENT_LIST.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.ELEMENT.getLexema())
//                                                             ));
...
//        element_list.put(LexemasEnum.L_CORCHETE.getLexema(),      Arrays.asList(
//                                                                //Arrays.asList(SimbolosEnum.ELEMENT_LIST.getLexema(), SimbolosEnum.COMA.getLexema(), SimbolosEnum.ELEMENT.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.ELEMENT.getLexema(), SimbolosEnum.COMA.getLexema(), SimbolosEnum.ELEMENT_LIST.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.ELEMENT.getLexema())
//                                                             ));
        ...
        tablaParsing.put(SimbolosEnum.ELEMENT_LIST.getLexema(), element_list);
        ...
        tablaParsing.put(SimbolosEnum.ELEMENT_LIST_PRIMA.getLexema(), element_list_prima);
...
//        attribute_list.put(LexemasEnum.LITERAL_CADENA.getLexema(),  Arrays.asList(
//                                                                //Arrays.asList(SimbolosEnum.ATTRIBUTE_LIST.getLexema(), SimbolosEnum.COMA.getLexema(), SimbolosEnum.ATTRIBUTE.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.ATTRIBUTE.getLexema(), SimbolosEnum.COMA.getLexema(), SimbolosEnum.ATTRIBUTE_LIST.getLexema()), 
//                                                                Arrays.asList(SimbolosEnum.ATTRIBUTE.getLexema())
//                                                             ));
        ...
        tablaParsing.put(SimbolosEnum.ATTRIBUTE_LIST.getLexema(), attribute_list);
        ...
        tablaParsing.put(SimbolosEnum.ATTRIBUTE_LIST_PRIMA.getLexema(), attribute_list_prima);
        ...
        attribute.put(LexemasEnum.LITERAL_CADENA.getLexema(),  Arrays.asList(SimbolosEnum.ATTRIBUTE_NAME.getLexema(), SimbolosEnum.DOS_PUNTOS.getLexema(), SimbolosEnum.ATTRIBUTE_VALUE.getLexema()));
        ...
        tablaParsing.put(SimbolosEnum.ATTRIBUTE.getLexema(), attribute);
        ...
        tablaParsing.put(SimbolosEnum.ATTRIBUTE_NAME.getLexema(), attribute_name);
        ...
        tablaParsing.put(SimbolosEnum.ATTRIBUTE_VALUE.getLexema(), attribute_value);                
    }
